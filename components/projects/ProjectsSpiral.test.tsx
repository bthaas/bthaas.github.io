...
describe('ProjectsSpiral', () => {
  ...
  it('morphs the same project list into Index view and back to Spiral view', () => {
    ...
    const viewToggle = screen.getByRole('group', { name: 'Toggle view' })
    ...
    expect(within(viewToggle).getByText('Toggle view')).toBeInTheDocument()
    ...
    expect(screen.getByRole('group', { name: 'Toggle view' })).toBe(viewToggle)
