...
| Gate | Result |
| --- | --- |
| `npm run verify` | Passed: 64 files / 250 tests, typecheck, and production build |
| `npm run test:coverage -- --maxWorkers=4` | Passed: 64 files / 250 tests; 90.90% statements, 80.89% branches, 87.41% functions, 94.46% lines |
